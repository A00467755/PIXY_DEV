...
namespace PIXY.Data
{
    public static class DbInitializer
    {
        public static void Initialize(PIXYContext context)
        {
            ...
            var users = new User[]
            {
                 new User{FirstName="Carson",LastName="Alexander",Email="abc@abc.com",PhoneNumber="1231234411",Address="adaddsafadfsdf",PostalCode="BH3-3C3",City="Halifax",Province="Nova Socotia",Country="Canada",UserName="AlexC",Password="dfsdfsd"},
                 new User{FirstName="Tim",LastName="Hortans",Email="ttc@tim.com",PhoneNumber="9029021111",Address="100 two two",PostalCode="12345-6789",City="New York City",Province="New York",Country="United State",UserName="tim",Password="dfsdfsd"}
           };
